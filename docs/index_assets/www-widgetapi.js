...
function wa(a,b){a.l={Pa:b,Va:!0};a.i=a.s||a.o}
...
function za(a){a.s=0;var b=a.l.Pa;a.l=null;return b}
function Aa(a){a.J=[a.l];a.s=0;a.o=0}
function Ba(a){var b=a.J.splice(0)[0];(b=a.l=a.l||b)?b.Va?a.i=a.s||a.o:void 0!=b.u&&a.o<b.u?(a.i=b.u,a.l=null):a.i=a.o:a.i=0}
...
function Fa(a){for(;a.i.i;)try{var b=a.j(a.i);if(b)return a.i.v=!1,{value:b.value,done:!1}}catch(c){a.i.j=void 0,wa(a.i,c)}a.i.v=!1;if(a.i.l){b=a.i.l;a.i.l=null;if(b.Va)throw b.Pa;return{value:b.return,done:!0}}return{value:void 0,done:!0}}
...
b.prototype.gb=function(g){if(g===this)this.o(new TypeError("A Promise cannot resolve to itself"));else if(g instanceof b)this.ib(g);else{a:switch(typeof g){case "object":var h=null!=g;break a;case "function":h=!0;break a;default:h=!1}h?this.fb(g):this.s(g)}};
b.prototype.fb=function(g){var h=void 0;try{h=g.then}catch(k){this.o(k);return}"function"==typeof h?this.jb(h,g):this.s(g)};
b.prototype.o=function(g){this.H(2,g)};
b.prototype.s=function(g){this.H(1,g)};
b.prototype.H=function(g,h){if(0!=this.i)throw Error("Cannot settle("+g+", "+h+"): Promise already settled in state"+this.i);this.i=g;this.l=h;2===this.i&&this.hb();this.J()};
b.prototype.hb=function(){var g=this;e(function(){if(g.ea()){var h=fa.console;"undefined"!==typeof h&&h.error(g.l)}},1)};
...
var f=new c;b.prototype.ib=function(g){var h=this.m();g.ra(h.resolve,h.reject)};
b.prototype.jb=function(g,h){var k=this.m();try{g.call(h,k.resolve,k.reject)}catch(l){k.reject(l)}};
...
var t=[],p=0;do t.push(void 0),p++,d(k.value).ra(q(t.length-1),m),k=h.next();while(!k.done)})};
return b});
...
c.prototype=b.prototype;a.N=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.Tb=function(d,e,f){for(var g=Array(arguments.length-2),h=2;h<arguments.length;h++)g[h-2]=arguments[h];return b.prototype[e].apply(d,g)}}
...
$b[" "]=function(){};var ec=E("Opera"),fc=E("Trident")||E("MSIE"),gc=E("Edge"),hc=E("Gecko")&&!(-1!=Lb().toLowerCase().indexOf("webkit")&&!E("Edge"))&&!(E("Trident")||E("MSIE"))&&!E("Edge"),ic=-1!=Lb().toLowerCase().indexOf("webkit")&&!E("Edge");function jc(){var a=A.document;return a?a.documentMode:void 0}
...
function xc(a,b){Ma(a);void 0===b&&(b=0);if(!wc){wc={};for(var c="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".split(""),d=["+/=","+/","-_=","-_.","-_"],e=0;5>e;e++){var f=c.concat(d[e].split(""));vc[e]=f;for(var g=0;g<f.length;g++){var h=f[g];void 0===wc[h]&&(wc[h]=g)}}}b=vc[b];c=Array(Math.floor(a.length/3));d=b[64]||"";for(e=f=0;f<a.length-2;f+=3){var k=a[f],l=a[f+1];h=a[f+2];g=b[k>>2];k=b[(k&3)<<4|l>>4];l=b[(l&15)<<2|h>>6];h=b[h&63];c[e++]=""+g+k+l+h}g=0;h=d;switch(a.length-
f){case 2:g=a[f+1],h=b[(g&15)<<2]||d;case 1:a=a[f],c[e]=""+b[a>>2]+b[(a&3)<<4|g>>4]+h+d}return c.join("")}
;var yc="undefined"!==typeof Uint8Array,zc={};var Bc;function Cc(a){if(zc!==zc)throw Error("illegal external caller");this.Ka=a;if(null!=a&&0===a.length)throw Error("ByteString should be constructed with non-empty values");}
Cc.prototype.isEmpty=function(){return null==this.Ka};var Dc="function"===typeof Symbol&&"symbol"===typeof Symbol()?Symbol(void 0):void 0;function Ec(a,b){Object.isFrozen(a)||(Dc?a[Dc]|=b:void 0!==a.W?a.W|=b:Object.defineProperties(a,{W:{value:b,configurable:!0,writable:!0,enumerable:!1}}))}
...
;function Yc(a){switch(typeof a){case "number":return isFinite(a)?a:String(a);case "object":if(a&&!Array.isArray(a)){if(yc&&null!=a&&a instanceof Uint8Array)return xc(a);if(a instanceof Cc){var b=a.Ka;null!=b&&"string"!==typeof b&&(yc&&b instanceof Uint8Array?b=xc(b):(La(b),b=null));return null==b?"":a.Ka=b}}}return a}
...
function id(a,b,c,d){d=void 0===d?!1:d;var e=d;a.i||(a.i={});var f=a.i[c];if(f)b=f;else if(b=Xc(ed(a,c,e),b))a.i[c]=b,Lc(a)&&Jc(b.C);if(null==b)return b;Lc(b)&&!Lc(a)&&(b=b.Ja(),F(a,c,b.C,d),a.i[c]=b);return b}
...
function sd(a,b){b.ia&&(a.ia=b.ia.slice());var c=b.i;if(c){b=b.j;for(var d in c){var e=c[d];if(e){var f=!(!b||!b[d]),g=+d;if(Array.isArray(e)){if(e.length){var h=a,k=e[0].constructor,l=f;l=void 0===l?!1:l;f=Lc(h);k=jd(h,k,g,l,f);g=fd(h,g,l);if(!(h=f)&&(h=g)){h=g;if(!Array.isArray(h))throw Error("cannot check mutability state of non-array");h=!(Fc(h)&8)}if(h){for(h=0;h<k.length;h++)(l=k[h])&&Lc(l)&&!f&&(k[h]=k[h].Ja(),g[h]=k[h].C);Kc(g,!0)}f=k;for(k=0;k<Math.min(f.length,e.length);k++)sd(f[k],e[k])}}else(f=
id(a,e.constructor,g,f))&&sd(f,e)}}}}
var pd;function td(){od.apply(this,arguments)}
v(td,od);td.prototype.Ja=function(){return this};
if(Tc){var ud={};Object.defineProperties(td,(ud[Symbol.hasInstance]=Uc(function(){throw Error("Cannot perform instanceof checks for MutableMessage");}),ud))};function vd(a,b,c,d,e,f){(a=a.i&&a.i[c])?Array.isArray(a)?(e=f.Ba?Hc(a.slice()):a,ld(b,0<e.length?e[0].constructor:void 0,c,e)):H(b,a.constructor,c,a):(yc&&d instanceof Uint8Array?e=d.length?new Cc(new Uint8Array(d)):Bc||(Bc=new Cc(null)):(Array.isArray(d)&&(e?Jc(d):Gc(d)&&f.Ba&&(d=d.slice())),e=d),F(b,c,e))}
;function I(){td.apply(this,arguments)}
v(I,td);I.prototype.Ja=function(){if(Lc(this)){var a={Ba:!0};var b=Lc(this);if(b&&!a.Ba)throw Error("copyRepeatedFields must be true for frozen messages");var c=new this.constructor;this.ia&&(c.ia=this.ia.slice());for(var d=this.C,e=0;e<d.length;e++){var f=d[e];if(e===d.length-1&&Pc(f))for(var g in f){var h=+g;Number.isNaN(h)?dd(c)[g]=f[g]:vd(this,c,h,f[g],b,a)}else vd(this,c,e-this.V,f,b,a)}a=c}else a=this;return a};
...
return a}
var Fd={Bb:"allow-forms",Cb:"allow-modals",Db:"allow-orientation-lock",Eb:"allow-pointer-lock",Fb:"allow-popups",Gb:"allow-popups-to-escape-sandbox",Hb:"allow-presentation",Ib:"allow-same-origin",Jb:"allow-scripts",Kb:"allow-top-navigation",Lb:"allow-top-navigation-by-user-activation"},Hd=bb(function(){return Gd()});
...
for(var e=[],f=[],g=[],h=[128],k=1;64>k;++k)h[k]=0;var l,m;a();return{reset:a,update:c,digest:d,mb:function(){for(var q=d(),t="",p=0;p<q.length;p++)t+="0123456789ABCDEF".charAt(Math.floor(q[p]/16))+"0123456789ABCDEF".charAt(q[p]%16);return t}}}
...
function Xd(a){var b=Sd();b.update(a);return b.mb().toLowerCase()}
;var Yd={};function Zd(a){this.i=a||{cookie:""}}
n=Zd.prototype;n.isEnabled=function(){if(!A.navigator.cookieEnabled)return!1;if(!this.isEmpty())return!0;this.set("TESTCOOKIESENABLED","1",{Da:60});if("1"!==this.get("TESTCOOKIESENABLED"))return!1;this.remove("TESTCOOKIESENABLED");return!0};
n.set=function(a,b,c){var d=!1;if("object"===typeof c){var e=c.Xb;d=c.secure||!1;var f=c.domain||void 0;var g=c.path||void 0;var h=c.Da}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');void 0===h&&(h=-1);c=f?";domain="+f:"";g=g?";path="+g:"";d=d?";secure":"";h=0>h?"":0==h?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(Date.now()+1E3*h)).toUTCString();this.i.cookie=a+"="+b+c+g+h+d+(null!=e?";samesite="+
e:"")};
...
de.prototype.l=!1;de.prototype.dispose=function(){this.l||(this.l=!0,this.ha())};
de.prototype.ha=function(){if(this.o)for(;this.o.length;)this.o.shift()()};function ee(a,b){this.type=a;this.i=this.target=b;this.defaultPrevented=this.l=!1}
...
ke.prototype.init=function(a,b){var c=this.type=a.type,d=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;this.target=a.target||a.srcElement;this.i=b;if(b=a.relatedTarget){if(hc){a:{try{$b(b.nodeName);var e=!0;break a}catch(f){}e=!1}e||(b=null)}}else"mouseover"==c?b=a.fromElement:"mouseout"==c&&(b=a.toElement);this.relatedTarget=b;d?(this.clientX=void 0!==d.clientX?d.clientX:d.pageX,this.clientY=void 0!==d.clientY?d.clientY:d.pageY,this.screenX=d.screenX||0,this.screenY=d.screenY||
...
ke.prototype.preventDefault=function(){ke.N.preventDefault.call(this);var a=this.j;a.preventDefault?a.preventDefault():a.returnValue=!1};var me="closure_listenable_"+(1E6*Math.random()|0);var ne=0;function oe(a,b,c,d,e){this.listener=a;this.proxy=null;this.src=b;this.type=c;this.capture=!!d;this.va=e;this.key=++ne;this.ka=this.qa=!1}
function pe(a){a.ka=!0;a.listener=null;a.proxy=null;a.src=null;a.va=null}
;function qe(a){this.src=a;this.listeners={};this.i=0}
qe.prototype.add=function(a,b,c,d,e){var f=a.toString();a=this.listeners[f];a||(a=this.listeners[f]=[],this.i++);var g=re(a,b,d,e);-1<g?(b=a[g],c||(b.qa=!1)):(b=new oe(b,this.src,f,!!d,e),b.qa=c,a.push(b));return b};
...
function re(a,b,c,d){for(var e=0;e<a.length;++e){var f=a[e];if(!f.ka&&f.listener==b&&f.capture==!!c&&f.va==d)return e}return-1}
...
function Fe(a){if("number"!==typeof a&&a&&!a.ka){var b=a.src;if(b&&b[me])se(b.i,a);else{var c=a.type,d=a.proxy;b.removeEventListener?b.removeEventListener(c,d,a.capture):b.detachEvent?b.detachEvent(Ce(c),d):b.addListener&&b.removeListener&&b.removeListener(d);ve--;(c=Ae(b))?(se(c,a),0==c.i&&(c.src=null,b[te]=null)):pe(a)}}}
function Ce(a){return a in ue?ue[a]:ue[a]="on"+a}
function De(a,b){if(a.ka)a=!0;else{b=new ke(b,this);var c=a.listener,d=a.va||a.src;a.qa&&Fe(a);a=c.call(d,b)}return a}
...
return a[Ge]}
;function He(){de.call(this);this.i=new qe(this);this.ea=this;this.H=null}
...
function Ie(a,b){var c=a.H;if(c){var d=[];for(var e=1;c;c=c.H)d.push(c),++e}a=a.ea;c=b.type||b;"string"===typeof b?b=new ee(b,a):b instanceof ee?b.target=b.target||a:(e=b,b=new ee(c,a),qb(b,e));e=!0;if(d)for(var f=d.length-1;!b.l&&0<=f;f--){var g=b.i=d[f];e=Je(g,c,!0,b)&&e}b.l||(g=b.i=a,e=Je(g,c,!0,b)&&e,b.l||(e=Je(g,c,!1,b)&&e));if(d)for(f=0;!b.l&&f<d.length;f++)g=b.i=d[f],e=Je(g,c,!1,b)&&e}
He.prototype.ha=function(){He.N.ha.call(this);if(this.i){var a=this.i,b=0,c;for(c in a.listeners){for(var d=a.listeners[c],e=0;e<d.length;e++)++b,pe(d[e]);delete a.listeners[c];a.i--}}this.H=null};
He.prototype.X=function(a,b,c,d){return this.i.add(String(a),b,!1,c,d)};
function Je(a,b,c,d){b=a.i.listeners[String(b)];if(!b)return!0;b=b.concat();for(var e=!0,f=0;f<b.length;++f){var g=b[f];if(g&&!g.ka&&g.capture==c){var h=g.listener,k=g.va||g.src;g.qa&&se(a.i,g);e=!1!==h.call(k,d)&&e}}return e&&!d.defaultPrevented}
...
if("undefined"!==typeof a&&!E("Trident")&&!E("MSIE")){var b=new a,c={},d=c;b.port1.onmessage=function(){if(void 0!==c.next){c=c.next;var e=c.Na;c.Na=null;e()}};
...
;function Of(a){this.i=0;this.v=void 0;this.m=this.j=this.l=null;this.o=this.s=!1;if(a!=$a)try{var b=this;a.call(void 0,function(c){Pf(b,2,c)},function(c){Pf(b,3,c)})}catch(c){Pf(this,3,c)}}
...
var ng=new gf(function(){return new Qf},function(a){a.reset()});
...
function Ag(a,b,c){var d=Bg;if(a=d.j[a]){var e=d.i;(a=a.find(function(f){return e[f+1]==b&&e[f+2]==c}))&&d.oa(a)}}
...
n.ha=function(){J.N.ha.call(this);this.clear();this.m.length=0};function Dg(a){this.i=a}
...
return e}
function yi(a){if(Pa(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);if(c){c=b;yb("HTML that is escaped and sanitized server-side and passed through yt.net.ajax");var d=a[b];if(void 0===rb){var e=null;var f=A.trustedTypes;if(f&&f.createPolicy){try{e=f.createPolicy("goog#html",{createHTML:Xa,createScript:Xa,createScriptURL:Xa})}catch(g){A.console&&A.console.error(g.message)}rb=e}else rb=e}d=(e=rb)?e.createHTML(d):d;a[c]=new Ob(d)}else yi(a[b])}}
...
function Hi(){return{innertubeApiKey:L("INNERTUBE_API_KEY"),innertubeApiVersion:L("INNERTUBE_API_VERSION"),Ca:L("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),Sa:L("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),rb:L("INNERTUBE_CONTEXT_CLIENT_NAME",1),innertubeContextClientVersion:L("INNERTUBE_CONTEXT_CLIENT_VERSION"),Ua:L("INNERTUBE_CONTEXT_HL"),Ta:L("INNERTUBE_CONTEXT_GL"),sb:L("INNERTUBE_HOST_OVERRIDE")||"",ub:!!L("INNERTUBE_USE_THIRD_PARTY_AUTH",!1),tb:!!L("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT",
!1),appInstallData:L("SERIALIZED_CLIENT_CONFIG_DATA")}}
function Ii(a){var b={client:{hl:a.Ua,gl:a.Ta,clientName:a.Sa,clientVersion:a.innertubeContextClientVersion,configInfo:a.Ca}};navigator.userAgent&&(b.client.userAgent=String(navigator.userAgent));var c=A.devicePixelRatio;c&&1!=c&&(b.client.screenDensityFloat=String(c));c=L("EXPERIMENTS_TOKEN","");""!==c&&(b.client.experimentsToken=c);c=hi();0<c.length&&(b.request={internalExperimentFlags:c});Ji(a,void 0,b);Ki(void 0,b);Li(a,void 0,b);Mi(void 0,b);L("DELEGATED_SESSION_ID")&&!N("pageid_as_header_web")&&
...
function Ji(a,b,c){a=a.Sa;if("WEB"===a||"MWEB"===a||1===a||2===a)if(b){c=id(b,Vg,96)||new Vg;var d=Ai();d=Object.keys(zi).indexOf(d);d=-1===d?null:d;null!==d&&F(c,3,d);H(b,Vg,96,c)}else c&&(c.client.mainAppWebInfo=null!=(d=c.client.mainAppWebInfo)?d:{},c.client.mainAppWebInfo.webDisplayMode=Ai())}
...
function Oi(a,b,c){c=void 0===c?{}:c;var d={};L("EOM_VISITOR_DATA")?d={"X-Goog-EOM-Visitor-Id":L("EOM_VISITOR_DATA")}:d={"X-Goog-Visitor-Id":c.visitorData||L("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.Sb||L("AUTHORIZATION"))||(a?b="Bearer "+B("gapi.auth.getToken")().Rb:b=ce([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=L("SESSION_INDEX",0),N("pageid_as_header_web")&&(d["X-Goog-PageId"]=L("DELEGATED_SESSION_ID")));return d}
...
Qi.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.i)try{this.i.set(a,b,Date.now()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(Mf(b))}catch(f){return}else e=escape(b);b=this.j;$d.set(""+a,e,{Da:c,path:"/",domain:void 0===b?"youtube.com":b,secure:!1})};
...
a);
if("AbortError"===e.name)return new R("UNKNOWN_ABORT",a,e.message);e.args=[Object.assign({},a,{name:"IdbError",Wb:e.name})];e.level="WARNING";return e}
...
function Tk(a){function b(){var f,g,h,k,l,m,q,t,p,y;return x(function(z){switch(z.i){case 1:return g=null!=(f=Error().stack)?f:"",xa(z,2),w(z,a.l(a.name,a.options.version,d),4);case 4:h=z.j;for(var G=a.options,K=[],M=u(Object.keys(G.ja)),O=M.next();!O.done;O=M.next()){O=O.value;var nb=G.ja[O],Ac=void 0===nb.xb?Number.MAX_VALUE:nb.xb;!(h.i.version>=nb.Aa)||h.i.version>=Ac||h.i.objectStoreNames.contains(O)||K.push(O)}k=K;if(0===k.length){z.u(5);break}l=Object.keys(a.options.ja);m=h.objectStoreNames();
...
;var Uk=new Qk("YtIdbMeta",{ja:{databases:{Aa:1}},upgrade:function(a,b){b(1)&&Lj(a,"databases",{keyPath:"actualName"})}});
...
;function ml(a){this.pa=this.i=!1;this.potentialEsfErrorCounter=this.j=0;this.handleError=function(){};
this.ca=function(){};
this.now=Date.now;this.ga=!1;var b;this.cb=null!=(b=a.cb)?b:100;var c;this.bb=null!=(c=a.bb)?c:1;var d;this.Za=null!=(d=a.Za)?d:2592E6;var e;this.Ya=null!=(e=a.Ya)?e:12E4;var f;this.ab=null!=(f=a.ab)?f:5E3;var g;this.A=null!=(g=a.A)?g:void 0;this.ta=!!a.ta;var h;this.sa=null!=(h=a.sa)?h:.1;var k;this.xa=null!=(k=a.xa)?k:10;a.handleError&&(this.handleError=a.handleError);a.ca&&(this.ca=a.ca);a.ga&&(this.ga=a.ga);a.pa&&(this.pa=a.pa);this.B=a.B;this.K=a.K;this.D=a.D;this.G=a.G;this.R=a.R;this.Ga=a.Ga;
this.Fa=a.Fa;nl(this)&&(!this.B||this.B("networkless_logging"))&&ol(this)}
function ol(a){nl(a)&&!a.ga&&(a.i=!0,a.ta&&Math.random()<=a.sa&&a.D.lb(a.A),pl(a),a.G.F()&&a.na(),a.G.X(a.Ga,a.na.bind(a)),a.G.X(a.Fa,a.Ma.bind(a)))}
...
n.na=function(){var a=this;if(!nl(this))throw yj("throttleSend");this.j||(this.j=this.K.O(function(){var b;return x(function(c){if(1==c.i)return w(c,a.D.Qa("NEW",a.A),2);if(3!=c.i)return b=c.j,b?w(c,ql(a,b),3):(a.Ma(),c.return());a.j&&(a.j=0,a.na());c.i=0})},this.cb))};
n.Ma=function(){this.K.Z(this.j);this.j=0};
function ql(a,b){var c,d;return x(function(e){switch(e.i){case 1:if(!nl(a))throw c=yj("immediateSend"),c;if(void 0===b.id){e.u(2);break}return w(e,a.D.wb(b.id,a.A),3);case 3:(d=e.j)?b=d:a.ca(Error("The request cannot be found in the database."));case 2:if(sl(a,b,a.Za)){e.u(4);break}a.ca(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===b.id){e.u(5);break}return w(e,a.D.aa(b.id,a.A),5);case 5:return e.return();case 4:b.skipRetry||(b=tl(a,b));if(!b){e.u(0);break}if(!b.skipRetry||
...
b.options.onError=function(e,f){var g,h,k;return x(function(l){switch(l.i){case 1:g=ul(f);if(!(a.B&&a.B("nwl_consider_error_code")&&g||a.B&&!a.B("nwl_consider_error_code")&&a.potentialEsfErrorCounter<=a.xa)){l.u(2);break}if(!a.G.la){l.u(3);break}return w(l,a.G.la(),3);case 3:if(a.G.F()){l.u(2);break}c(e,f);if(!a.B||!a.B("nwl_consider_error_code")||void 0===(null==(h=b)?void 0:h.id)){l.u(6);break}return w(l,a.D.Ha(b.id,a.A,!1),6);case 6:return l.return();case 2:if(a.B&&a.B("nwl_consider_error_code")&&
!g&&a.potentialEsfErrorCounter>a.xa)return l.return();a.potentialEsfErrorCounter++;if(void 0===(null==(k=b)?void 0:k.id)){l.u(8);break}return b.sendCount<a.bb?w(l,a.D.Ha(b.id,a.A),12):w(l,a.D.aa(b.id,a.A),8);case 12:a.K.O(function(){a.G.F()&&a.na()},a.ab);
case 8:c(e,f),l.i=0}})};
...
function pl(a){if(!nl(a))throw yj("retryQueuedRequests");a.D.Qa("QUEUED",a.A).then(function(b){b&&!sl(a,b,a.Ya)?a.K.O(function(){return x(function(c){if(1==c.i)return void 0===b.id?c.u(2):w(c,a.D.Ha(b.id,a.A),2);pl(a);c.i=0})}):a.G.F()&&a.na()})}
function rl(a,b){a.eb&&!a.G.F()?a.eb(b):a.handleError(b)}
function nl(a){return!!a.A||a.pa}
...
;var Kl={},Ll=yl("ServiceWorkerLogsDatabase",{ja:(Kl.SWHealthLog={Aa:1},Kl),Ia:!0,upgrade:function(a,b){b(1)&&Lj(a,"SWHealthLog",{keyPath:"id",autoIncrement:!0}).i.createIndex("swHealthNewRequest",["interface","timestamp"],{unique:!1})},
...
n.qb=function(){var a=window.navigator.onLine;return void 0===a?!0:a};
n.nb=function(){this.m=!0};
n.X=function(a,b){return this.j.X(a,b)};
n.la=function(a){a=Le(this.j,a);a.then(function(b){N("use_cfr_monitor")&&Tl().requestComplete("generate_204",b)});
return a};
Y.prototype.sendNetworkCheckRequest=Y.prototype.la;Y.prototype.listen=Y.prototype.X;Y.prototype.enableErrorFlushing=Y.prototype.nb;Y.prototype.getWindowStatus=Y.prototype.qb;Y.prototype.networkStatusHint=Y.prototype.P;Y.prototype.isNetworkAvailable=Y.prototype.F;Y.getInstance=Xl;function Yl(a){a=void 0===a?{}:a;He.call(this);var b=this;this.j=this.v=0;this.m=Xl();var c=B("yt.networkStatusManager.instance.listen").bind(this.m);c&&(a.ya?(this.ya=a.ya,c("networkstatus-online",function(){Zl(b,"publicytnetworkstatus-online")}),c("networkstatus-offline",function(){Zl(b,"publicytnetworkstatus-offline")})):(c("networkstatus-online",function(){Ie(b,"publicytnetworkstatus-online")}),c("networkstatus-offline",function(){Ie(b,"publicytnetworkstatus-offline")})))}
...
Yl.prototype.la=function(a){var b=this,c;return x(function(d){c=B("yt.networkStatusManager.instance.sendNetworkCheckRequest").bind(b.m);return N("skip_network_check_if_cfr")&&Tl().isEndpointCFR("generate_204")?d.return(new Promise(function(e){var f;b.P((null==(f=window.navigator)?void 0:f.onLine)||!0);e(b.F())})):c?d.return(c(a)):d.return(!0)})};
function Zl(a,b){a.ya?a.j?(Oe.Z(a.v),a.v=Oe.O(function(){a.s!==b&&(Ie(a,b),a.s=b,a.j=P())},a.ya-(P()-a.j))):(Ie(a,b),a.s=b,a.j=P()):Ie(a,b)}
;var $l;function am(){ml.call(this,{D:{lb:Il,aa:Hl,Qa:El,wb:Fl,Ha:Gl,set:Cl},G:bm(),handleError:Lh,ca:Mh,R:cm,now:P,eb:Wl,K:bj(),Ga:"publicytnetworkstatus-online",Fa:"publicytnetworkstatus-offline",ta:!0,sa:.1,xa:gi("potential_esf_error_limit",10),B:N,ga:!(kj()&&"www.youtube-nocookie.com"!==Rb(document.location.toString()))});this.l=new Nf;N("networkless_immediately_drop_all_requests")&&Jl();ll("LogsDatabaseV2")}
v(am,ml);function dm(){var a=B("yt.networklessRequestController.instance");a||(a=new am,C("yt.networklessRequestController.instance",a),N("networkless_logging")&&dl().then(function(b){a.A=b;ol(a);a.l.resolve();a.ta&&Math.random()<=a.sa&&a.A&&Nl(a.A);N("networkless_immediately_drop_sw_health_store")&&em(a)}));
return a}
...
function bm(){$l||($l=new Yl({vb:!0,ob:!0}));return $l}
...
a.options.onError=function(e,f){var g,h,k;return x(function(l){switch(l.i){case 1:N("use_cfr_monitor")&&Tl().requestComplete(a.url,!1);g=ul(f);if(!(N("nwl_consider_error_code")&&g||!N("nwl_consider_error_code")&&sm()<=gi("potential_esf_error_limit",10))){l.u(2);break}if(N("skip_checking_network_on_cfr_failure")&&(!N("skip_checking_network_on_cfr_failure")||Tl().isEndpointCFR(a.url))){l.u(3);break}return w(l,lm().la(),3);case 3:if(lm().F()){l.u(2);break}c(e,f);if(!N("nwl_consider_error_code")||void 0===
...
return a}
function lm(){if(N("use_new_nwl"))return bm();im||(im=new Yl({vb:!0,ob:!0}));return im}
...
zm.prototype.za=function(a,b){this.store.push({payload:b,keys:a});b=[void 0===a.auth?"undefined":a.auth,void 0===a.isJspb?"undefined":a.isJspb,void 0===a.isLeader?"undefined":a.isLeader,void 0===a.cttAuthInfo?"undefined":a.cttAuthInfo].join("/");this.i[b]?this.i[b]++:this.i[b]=1;this.i[b]>=this.policy.maxBatchSize&&(this.policy.onBatchSizeExceeded(a),this.i[b]=0);return b};
zm.prototype.ba=function(a){for(var b=[],c=[],d=u(this.store),e=d.next();!e.done;e=d.next()){e=e.value;a:{var f=a;var g=Object.keys(f);g=u(g);for(var h=g.next();!h.done;h=g.next())if(h=h.value,e.keys[h]!==f[h]){f=!1;break a}f=!0}f?b.push(e.payload):c.push(e)}this.store=c;c=0;a=Am(this,a);a=u(a);for(d=a.next();!d.done;d=a.next())d=d.value,c+=this.i[d],this.i[d]=0;c!==b.length&&Mh(new jj("Transport IMS extracted entries count != keyCounter sum",b.length,c));return b};
zm.prototype.Ra=function(a){var b=Am(this,a);a=0;b=u(b);for(var c=b.next();!c.done;c=b.next())a+=this.i[c.value];return a};
function Am(a,b){var c=Object.keys(b),d="THIS_KEY_FIELD_NOT_FILLED",e="THIS_KEY_FIELD_NOT_FILLED",f="THIS_KEY_FIELD_NOT_FILLED",g="THIS_KEY_FIELD_NOT_FILLED";c=u(c);for(var h=c.next();!h.done;h=c.next())h=h.value,"auth"===h?d=Bm(b.auth):"isJspb"===h?e=JSON.stringify(b.isJspb):"isLeader"===h?f=JSON.stringify(b.isLeader):"cttAuthInfo"===h&&(g=Bm(b.cttAuthInfo));b=[];d=[d,e,f,g];a=u(Object.keys(a.i));for(e=a.next();!e.done;e=a.next()){e=e.value;f=e.split("/");g=!0;for(c=0;c<d.length;c++)if("THIS_KEY_FIELD_NOT_FILLED"!==
d[c]&&d[c]!==f[c]){g=!1;break}g&&b.push(e)}return b}
zm.prototype.getSequenceCount=zm.prototype.Ra;zm.prototype.extractMatchingEntries=zm.prototype.ba;zm.prototype.storePayload=zm.prototype.za;function Bm(a){return void 0===a?"undefined":a}
;var Cm=A.window;Cm.ytExports||(Cm.ytExports={logging:{transport:{leaderQueueLength:0,leaderChosen:!1}}});var Dm=gi("initial_gel_batch_timeout",2E3),Em=Math.pow(2,16)-1,Fm=!1,Gm=void 0;function Hm(){this.l=this.i=this.j=0}
var Im=new Hm,Jm=new Hm,Km=!0,Lm=A.ytLoggingTransportGELQueue_||new Map;C("ytLoggingTransportGELQueue_",Lm);var Mm=new Map,Nm=A.ytLoggingTransportGELProtoQueue_||new Map;C("ytLoggingTransportGELProtoQueue_",Nm);var Om=A.ytLoggingTransportTokensToCttTargetIds_||{};C("ytLoggingTransportTokensToCttTargetIds_",Om);var Pm=A.ytLoggingTransportTokensToJspbCttTargetIds_||{};C("ytLoggingTransportTokensToJspbCttTargetIds_",Pm);var Qm={};
function Rm(){var a=B("yt.logging.ims");a||(a=new zm({maxBatchSize:gi("tvhtml5_logging_max_batch")||gi("web_logging_max_batch")||100,onBatchSizeExceeded:function(b){Sm({writeThenSend:!0},void 0,b.isJspb)}}),C("yt.logging.ims",a));
return a}
function Tm(){N("jspb_with_transport_leader")&&!Cm.ytExports.logging.transport.leaderChosen&&(Fm=Cm.ytExports.logging.transport.leaderChosen=!0,document.addEventListener("FLUSH_REQUEST",function(){Sm(void 0,void 0,!0)}))}
function Um(a,b){Tm();if("log_event"===a.endpoint){Vm(a);var c=Wm(a);if(N("use_new_in_memory_storage")){Qm[c]=!0;var d={cttAuthInfo:c,isJspb:!1,isLeader:Fm};Rm().za(d,a.payload);Xm(b,[],c,!1,d)}else d=Lm.get(c)||[],Lm.set(c,d),d.push(a.payload),Xm(b,d,c)}}
function Ym(a,b){Tm();if("log_event"===a.endpoint){Vm(void 0,a);var c=Wm(a,!0);if(N("jspb_with_transport_leader")&&Fm)if(N("use_new_in_memory_storage")){Qm[c]=!0;var d={cttAuthInfo:c,isJspb:!0,isLeader:Fm};Rm().za(d,a.payload);Cm.ytExports.logging.transport.leaderQueueLength++;Xm(b,[],c,!0,d)}else d=Mm.get(c)||[],Mm.set(c,d),Cm.ytExports.logging.transport.leaderQueueLength++,d.push(a.payload),Xm(b,d,c,!0);else N("use_new_in_memory_storage")?(Qm[c]=!0,d={cttAuthInfo:c,isJspb:!0,isLeader:Fm},Rm().za(d,
a.payload.toJSON()),Xm(b,[],c,!0,d)):(d=Nm.get(c)||[],Nm.set(c,d),a=a.payload.toJSON(),d.push(a),Xm(b,d,c,!0))}}
function Xm(a,b,c,d,e){d=void 0===d?!1:d;a&&(Gm=new a);a=gi("tvhtml5_logging_max_batch")||gi("web_logging_max_batch")||100;var f=P(),g=d?Jm.l:Im.l,h=Nm.get(c)||[];b=b.length;e&&(e=mb(e),delete e.isLeader,b=Rm().Ra(e));N("jspb_with_transport_leader")&&(Fm&&b+h.length>=a||!Fm&&Cm.ytExports.logging.transport.leaderQueueLength+b>=a)||b>=a?Sm({writeThenSend:!0},N("flush_only_full_queue")?c:void 0,d):10<=f-g&&(Zm(d),d?Jm.l=f:Im.l=f)}
function $m(a,b){Tm();if("log_event"===a.endpoint){Vm(a);var c=Wm(a),d=new Map;d.set(c,[a.payload]);b&&(Gm=new b);return new Of(function(e,f){Gm&&Gm.isReady()?an(d,Gm,e,f,{bypassNetworkless:!0},!0):e()})}}
function bn(a,b){Tm();if("log_event"===a.endpoint){Vm(void 0,a);var c=Wm(a,!0),d=new Map,e=new Map;N("jspb_with_transport_leader")&&Fm?e.set(c,[a.payload]):d.set(c,[a.payload.toJSON()]);b&&(Gm=new b);return new Of(function(f){Gm&&Gm.isReady()?cn(d,e,Gm,f,{bypassNetworkless:!0},!0):f()})}}
function Wm(a,b){var c="";if(a.fa)c="visitorOnlyApprovedKey";else if(a.cttAuthInfo){if(void 0===b?0:b){b=a.cttAuthInfo.token;c=a.cttAuthInfo;var d=new xh;c.videoId?d.setVideoId(c.videoId):c.playlistId&&gd(d,2,yh,c.playlistId);Pm[b]=d}else b=a.cttAuthInfo,c={},b.videoId?c.videoId=b.videoId:b.playlistId&&(c.playlistId=b.playlistId),Om[a.cttAuthInfo.token]=c;c=a.cttAuthInfo.token}return c}
function Sm(a,b,c){a=void 0===a?{}:a;c=void 0===c?!1:c;new Of(function(d,e){c?(window.clearTimeout(Jm.j),window.clearTimeout(Jm.i),Jm.i=0):(window.clearTimeout(Im.j),window.clearTimeout(Im.i),Im.i=0);if(N("jspb_with_transport_leader")&&!Fm&&c)document.dispatchEvent(new CustomEvent("FLUSH_REQUEST")),d();else if(Gm&&Gm.isReady())if(N("use_new_in_memory_storage"))a:{var f=a,g=c,h=Gm;f=void 0===f?{}:f;g=void 0===g?!1:g;var k=new Map,l=new Map,m=new Map;if(void 0!==b){if(g){e=Rm().ba({isJspb:g,cttAuthInfo:b,
isLeader:!1});k.set(b,e);if(N("jspb_with_transport_leader")){e=Rm().ba({isJspb:!0,cttAuthInfo:b,isLeader:!0});if(0===e.length)break a;l.set(b,e)}cn(k,l,h,d,f)}}else if(g){e=u(Object.keys(Qm));for(g=e.next();!g.done;g=e.next())m=g.value,g=Rm().ba({isJspb:!0,isLeader:!1,cttAuthInfo:m}),0<g.length&&k.set(m,g),N("jspb_with_transport_leader")&&(g=Rm().ba({isJspb:!0,isLeader:!0,cttAuthInfo:m}),0<g.length&&l.set(m,g)),Qm[m]=!1;cn(k,l,h,d,f)}else{k=u(Object.keys(Qm));for(g=k.next();!g.done;g=k.next())l=g.value,
g=Rm().ba({isJspb:!1,cttAuthInfo:l}),0!==g.length&&m.set(l,g);an(m,h,d,e,f)}}else f=a,k=c,h=Gm,f=void 0===f?{}:f,k=void 0===k?!1:k,void 0!==b?k?(e=new Map,k=new Map,l=Nm.get(b)||[],e.set(b,l),N("jspb_with_transport_leader")&&(l=Mm.get(b)||[],k.set(b,l)),cn(e,k,h,d,f),N("jspb_with_transport_leader")&&Mm.delete(b),Nm.delete(b)):(k=new Map,l=Lm.get(b)||[],k.set(b,l),an(k,h,d,e,f),Lm.delete(b)):k?(cn(Nm,Mm,h,d,f),Nm.clear(),N("jspb_with_transport_leader")&&Mm.clear()):(an(Lm,h,d,e,f),Lm.clear());else Zm(c),
d()})}
function Zm(a){a=void 0===a?!1:a;if(N("web_gel_timeout_cap")&&(!a&&!Im.i||a&&!Jm.i)){var b=Vh(function(){Sm({writeThenSend:!0},void 0,a)},6E4);
a?Jm.i=b:Im.i=b}window.clearTimeout(a?Jm.j:Im.j);b=L("LOGGING_BATCH_TIMEOUT",gi("web_gel_debounce_ms",1E4));N("shorten_initial_gel_batch_timeout")&&Km&&(b=Dm);b=Vh(function(){Sm({writeThenSend:!0},void 0,a)},b);
a?Jm.j=b:Im.j=b}
function an(a,b,c,d,e,f){e=void 0===e?{}:e;var g=Math.round(P()),h=a.size;a=u(a);for(var k=a.next();!k.done;k=a.next()){var l=u(k.value);k=l.next().value;var m=l.next().value;l=k;k=ob({context:Ii(b.config_||Hi())});if(!Ma(m)&&!N("throw_err_when_logevent_malformed_killswitch")){Lh(new jj("LogEvent value at event was not an array",m));d();break}k.events=m;(m=Om[l])&&dn(k,l,m);delete Om[l];l="visitorOnlyApprovedKey"===l;en(k,g,l);fn(e);m=function(){h--;h||c()};
var q=function(){h--;h||c()};
try{Xi(b,"log_event",k,gn(e,l,m,q,f)),Km=!1}catch(t){Lh(t),d()}}}
function cn(a,b,c,d,e,f){e=void 0===e?{}:e;var g=Math.round(P()),h=a.size+b.size,k=new Map([].concat(ia(a),ia(b)));k=u(k);for(var l=k.next();!l.done;l=k.next()){var m=u(l.value).next().value,q=a.get(m),t=b.get(m)||[];l=new zh;var p=Ni(c.config_||Hi());H(l,eh,1,p);q=q?hn(q):[];q=u(q);for(p=q.next();!p.done;p=q.next())md(l,3,uh,p.value);t=u(t);for(q=t.next();!q.done;q=t.next())md(l,3,uh,q.value);(t=Pm[m])&&jn(l,m,t);delete Pm[m];m="visitorOnlyApprovedKey"===m;kn(l,g,m);fn(e);l=qd(l);m=gn(e,m,function(){Cm.ytExports.logging.transport.leaderQueueLength=
0;h--;h||d()},function(){Cm.ytExports.logging.transport.leaderQueueLength=0;
h--;h||d()},f);
m.headers["Content-Type"]="application/json+protobuf";m.postBodyFormat="JSPB";m.postBody=l;Xi(c,"log_event","",m);Km=!1}}
function fn(a){N("always_send_and_write")&&(a.writeThenSend=!1)}
function gn(a,b,c,d,e){a={retry:!0,onSuccess:c,onError:d,Wa:a,fa:b,Ub:!!e,headers:{},postBodyFormat:"",postBody:""};N("use_request_time_ms_header")&&(a.headers["X-Goog-Request-Time"]=JSON.stringify(Math.round(P())));return a}
function en(a,b,c){a.requestTimeMs=String(b);N("unsplit_gel_payloads_in_logs")&&(a.unsplitGelPayloadsInLogs=!0);!c&&(b=L("EVENT_ID"))&&(c=ln(),a.serializedClientEventId={serializedEventId:b,clientCounter:String(c)})}
function kn(a,b,c){F(a,2,b);if(!c&&(b=L("EVENT_ID"))){c=ln();var d=new wh;F(d,1,b);F(d,2,c);H(a,wh,5,d)}}
function ln(){var a=L("BATCH_CLIENT_COUNTER")||0;a||(a=Math.floor(Math.random()*Em/2));a++;a>Em&&(a=1);Fh("BATCH_CLIENT_COUNTER",a);return a}
...
function jn(a,b,c){if(ed(c,1===hd(c,yh)?1:-1))var d=1;else if(c.getPlaylistId())d=2;else return;H(a,xh,4,c);a=id(a,eh,1)||new eh;c=id(a,ch,3)||new ch;var e=new bh;e.setToken(b);F(e,1,d);md(c,12,bh,e);H(a,ch,3,c)}
function hn(a){for(var b=[],c=0;c<a.length;c++)try{b.push(new uh(a[c]))}catch(d){Lh(new jj("Transport failed to deserialize "+String(a[c])))}return b}
function Vm(a,b){if(B("yt.logging.transport.enableScrapingForTest")){var c=B("yt.logging.transport.scrapedPayloadsForTesting"),d=B("yt.logging.transport.payloadToScrape","");b&&(b=B("yt.logging.transport.getScrapedPayloadFromClientEventsFunction").bind(b.payload)())&&c.push(b);a&&a.payload[d]&&c.push((null==a?void 0:a.payload)[d]);C("yt.logging.transport.scrapedPayloadsForTesting",c)}}
;var mn=A.ytLoggingGelSequenceIdObj_||{};C("ytLoggingGelSequenceIdObj_",mn);function nn(a,b,c,d){d=void 0===d?{}:d;var e={},f=Math.round(d.timestamp||P());e.eventTimeMs=f<Number.MAX_SAFE_INTEGER?f:0;e[a]=b;a=um();e.context={lastActivityMs:String(d.timestamp||!isFinite(a)?-1:a)};N("log_sequence_info_on_gel_web")&&d.ma&&(a=e.context,b=d.ma,b={index:on(b),groupKey:b},a.sequence=b,d.pb&&delete mn[d.ma]);(d.yb?$m:Um)({endpoint:"log_event",payload:e,cttAuthInfo:d.cttAuthInfo,fa:d.fa},c)}
function pn(a){Sm(void 0,void 0,void 0===a?!1:a)}
function on(a){mn[a]=a in mn?mn[a]+1:0;return mn[a]}
;var qn=A.ytLoggingGelSequenceIdObj_||{};C("ytLoggingGelSequenceIdObj_",qn);function rn(a){var b=void 0;b=void 0===b?{}:b;var c=!1;L("ytLoggingEventsDefaultDisabled",!1)&&(c=!0);c=c?null:tm;b=void 0===b?{}:b;var d=Math.round(b.timestamp||P());F(a,1,d<Number.MAX_SAFE_INTEGER?d:0);var e=um();d=new th;F(d,1,b.timestamp||!isFinite(e)?-1:e);if(N("log_sequence_info_on_gel_web")&&b.ma){e=b.ma;var f=on(e),g=new sh;F(g,2,f);F(g,1,e);H(d,sh,3,g);b.pb&&delete qn[b.ma]}H(a,th,33,d);(b.yb?bn:Ym)({endpoint:"log_event",payload:a,cttAuthInfo:b.cttAuthInfo,fa:b.fa},c)}
;function sn(a,b){var c=void 0===c?{}:c;if(N("migrate_events_to_ts")){c=void 0===c?{}:c;var d=tm;L("ytLoggingEventsDefaultDisabled",!1)&&tm===tm&&(d=null);nn(a,b,d,c)}else d=tm,L("ytLoggingEventsDefaultDisabled",!1)&&tm==tm&&(d=null),nn(a,b,d,c)}
;var tn=[{Ea:function(a){return"Cannot read property '"+a.key+"'"},
...
wa:{ReferenceError:[{regexp:/(.*) is not defined/,groups:["key"]},{regexp:/Can't find variable: (.*)/,groups:["key"]}]}}];var vn={U:[],S:[{kb:un,weight:500}]};function un(a){if("JavaException"===a.name)return!0;a=a.stack;return a.includes("chrome://")||a.includes("chrome-extension://")||a.includes("moz-extension://")}
;function wn(){this.S=[];this.U=[]}
var xn;function yn(){if(!xn){var a=xn=new wn;a.U.length=0;a.S.length=0;vn.U&&a.U.push.apply(a.U,vn.U);vn.S&&a.S.push.apply(a.S,vn.S)}return xn}
;var zn=new J;function An(a){function b(){return a.charCodeAt(d++)}
var c=a.length,d=0;do{var e=Bn(b);if(Infinity===e)break;var f=e>>3;switch(e&7){case 0:e=Bn(b);if(2===f)return e;break;case 1:if(2===f)return;d+=8;break;case 2:e=Bn(b);if(2===f)return a.substr(d,e);d+=e;break;case 5:if(2===f)return;d+=4;break;default:return}}while(d<c)}
function Bn(a){var b=a(),c=b&127;if(128>b)return c;b=a();c|=(b&127)<<7;if(128>b)return c;b=a();c|=(b&127)<<14;if(128>b)return c;b=a();return 128>b?c|(b&127)<<21:Infinity}
;function Cn(a,b,c,d){if(a)if(Array.isArray(a)){var e=d;for(d=0;d<a.length&&!(a[d]&&(e+=Dn(d,a[d],b,c),500<e));d++);d=e}else if("object"===typeof a)for(e in a){if(a[e]){var f=a[e];var g=b;var h=c;g="string"!==typeof f||"clickTrackingParams"!==e&&"trackingParams"!==e?0:(f=An(atob(f.replace(/-/g,"+").replace(/_/g,"/"))))?Dn(e+".ve",f,g,h):0;d+=g;d+=Dn(e,a[e],b,c);if(500<d)break}}else c[b]=En(a),d+=c[b].length;else c[b]=En(a),d+=c[b].length;return d}
function Dn(a,b,c,d){c+="."+a;a=En(b);d[c]=a;return c.length+a.length}
function En(a){try{return("string"===typeof a?a:String(JSON.stringify(a))).substr(0,500)}catch(b){return"unable to serialize "+typeof a+" ("+b.message+")"}}
;var Fn=new Set,Gn=0,Hn=0,In=0,Jn=[],Kn=["PhantomJS","Googlebot","TO STOP THIS SECURITY SCAN go/scan"];function Ln(){for(var a=u(Kn),b=a.next();!b.done;b=a.next()){var c=Lb();if(c&&0<=c.toLowerCase().indexOf(b.value.toLowerCase()))return!0}return!1}
...
;var Pn={},Qn=[],Bg=new J,Rn={};function Sn(){for(var a=u(Qn),b=a.next();!b.done;b=a.next())b=b.value,b()}
...
function Un(a){Bg.da.apply(Bg,arguments)}
...
function Wn(a,b,c){Xn||(Xn={},Uh(window,"message",function(d){a:{if(d.origin===Z(a,"host")){try{var e=JSON.parse(d.data)}catch(f){e=void 0;break a}if(d=Xn[e.id])d.v=!0,d.v&&(D(d.s,d.sendMessage,d),d.s.length=0),d.La(e)}e=void 0}return e}));
Xn[c]=b}
var Xn=null;var Yn=window;function Zn(a,b,c){this.o=this.i=this.j=null;this.l=0;this.v=!1;this.s=[];this.m=null;this.J={};if(!a)throw Error("YouTube player element ID required.");this.id=Qa(this);this.H=c;this.setup(a,b)}
n=Zn.prototype;n.setSize=function(a,b){this.i.width=a.toString();this.i.height=b.toString();return this};
n.getIframe=function(){return this.i};
n.La=function(a){$n(this,a.event,a)};
n.addEventListener=function(a,b){var c=b;"string"===typeof b&&(c=function(){window[b].apply(window,arguments)});
if(!c)return this;this.m.subscribe(a,c);ao(this,a);return this};
function bo(a,b){b=b.split(".");if(2===b.length){var c=b[1];a.H===b[0]&&ao(a,c)}}
n.destroy=function(){this.i&&this.i.id&&(Pn[this.i.id]=null);var a=this.m;a&&"function"==typeof a.dispose&&a.dispose();if(this.o){a=this.i;var b=a.parentNode;b&&b.replaceChild(this.o,a)}else(a=this.i)&&a.parentNode&&a.parentNode.removeChild(a);Xn&&(Xn[this.id]=null);this.j=null;a=this.i;for(var c in kb)kb[c][0]==a&&Sh(c);this.o=this.i=null};
n.Oa=function(){return{}};
function co(a,b,c){c=c||[];c=Array.prototype.slice.call(c);b={event:"command",func:b,args:c};a.v?a.sendMessage(b):a.s.push(b)}
function $n(a,b,c){a.m.l||(c={target:a,data:c},a.m.da(b,c),Un(a.H+"."+b,c))}
function eo(a,b){var c=document.createElement("iframe");b=b.attributes;for(var d=0,e=b.length;d<e;d++){var f=b[d].value;null!=f&&""!==f&&"null"!==f&&c.setAttribute(b[d].name,f)}c.setAttribute("frameBorder","0");c.setAttribute("allowfullscreen","1");c.setAttribute("allow","accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture");c.setAttribute("title","YouTube "+Z(a.j,"title"));(b=Z(a.j,"width"))&&c.setAttribute("width",b.toString());(b=Z(a.j,"height"))&&c.setAttribute("height",
b.toString());var g=a.Oa();g.enablejsapi=window.postMessage?1:0;window.location.host&&(g.origin=window.location.protocol+"//"+window.location.host);g.widgetid=a.id;window.location.href&&D(["debugjs","debugcss"],function(k){var l=Wb(window.location.href,k);null!==l&&(g[k]=l)});
Yn.yt_embedsTokenValue&&(g.embedsTokenValue=encodeURIComponent(Yn.yt_embedsTokenValue),delete Yn.yt_embedsTokenValue);var h=""+Z(a.j,"host")+("/embed/"+Z(a.j,"videoId"))+"?"+Ub(g);Yn.yt_embedsEnableUaChProbe?Mn().then(function(k){var l=new URL(h),m=Number(l.searchParams.get("reloads"));isNaN(m)&&(m=0);l.searchParams.set("reloads",(m+1).toString());k&&l.searchParams.set("uach",k);l.searchParams.set("uats",Math.floor(window.performance.timeOrigin).toString());k=Nd(l.href).toString();Ad(c,Od(k));return k}):
Yn.yt_embedsEnableIframeSrcWithIntent?Ad(c,Od(h)):c.src=h;
return c}
n.Xa=function(){this.i&&this.i.contentWindow?this.sendMessage({event:"listening"}):window.clearInterval(this.l)};
function fo(a){Wn(a.j,a,a.id);a.l=Wh(a.Xa.bind(a));Uh(a.i,"load",function(){window.clearInterval(a.l);a.l=Wh(a.Xa.bind(a))})}
n.setup=function(a,b){var c=document;if(a="string"===typeof a?c.getElementById(a):a)if(c="iframe"===a.tagName.toLowerCase(),b.host||(b.host=c?Sb(a.src):"https://www.youtube.com"),this.j=new Vn(b),c||(b=eo(this,a),this.o=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.i=a,this.i.id||(this.i.id="widget"+Qa(this.i)),Pn[this.i.id]=this,window.postMessage){this.m=new J;fo(this);b=Z(this.j,"events");for(var d in b)b.hasOwnProperty(d)&&this.addEventListener(d,b[d]);for(var e in Rn)Rn.hasOwnProperty(e)&&
bo(this,e)}};
function ao(a,b){a.J[b]||(a.J[b]=!0,co(a,"addEventListener",[b]))}
n.sendMessage=function(a){a.id=this.id;a.channel="widget";var b=JSON.stringify(a),c=[Sb(this.i.src||"").replace("http:","https:")];if(this.i.contentWindow)for(var d=0;d<c.length;d++)try{this.i.contentWindow.postMessage(b,c[d])}catch(ac){if(ac.name&&"SyntaxError"===ac.name){if(!(ac.message&&0<ac.message.indexOf("target origin ''"))){var e=void 0,f=ac;e=void 0===e?{}:e;e.name=L("INNERTUBE_CONTEXT_CLIENT_NAME",1);e.version=L("INNERTUBE_CONTEXT_CLIENT_VERSION");var g=e||{},h="WARNING";h=void 0===h?"ERROR":
h;if(f){f.hasOwnProperty("level")&&f.level&&(h=f.level);if(N("console_log_js_exceptions")){var k=f,l=[];l.push("Name: "+k.name);l.push("Message: "+k.message);k.hasOwnProperty("params")&&l.push("Error Params: "+JSON.stringify(k.params));k.hasOwnProperty("args")&&l.push("Error args: "+JSON.stringify(k.args));l.push("File name: "+k.fileName);l.push("Stacktrace: "+k.stack);window.console.log(l.join("\n"),k)}if(!(5<=Gn)){var m=void 0,q=void 0,t=f,p=g,y=fe(t),z=y.message||"Unknown Error",G=y.name||"UnknownError",
K=y.stack||t.j||"Not available";if(K.startsWith(G+": "+z)){var M=K.split("\n");M.shift();K=M.join("\n")}var O=y.lineNumber||"Not available",nb=y.fileName||"Not available",Ac=K,va=0;if(t.hasOwnProperty("args")&&t.args&&t.args.length)for(var pa=0;pa<t.args.length&&!(va=Cn(t.args[pa],"params."+pa,p,va),500<=va);pa++);else if(t.hasOwnProperty("params")&&t.params){var X=t.params;if("object"===typeof t.params)for(q in X){if(X[q]){var ca="params."+q,da=En(X[q]);p[ca]=da;va+=ca.length+da.length;if(500<va)break}}else p.params=
En(X)}if(Jn.length)for(var W=0;W<Jn.length&&!(va=Cn(Jn[W],"params.context."+W,p,va),500<=va);W++);navigator.vendor&&!p.hasOwnProperty("vendor")&&(p["device.vendor"]=navigator.vendor);var S={message:z,name:G,lineNumber:O,fileName:nb,stack:Ac,params:p,sampleWeight:1},Qj=Number(t.columnNumber);isNaN(Qj)||(S.lineNumber=S.lineNumber+":"+Qj);if("IGNORED"===t.level)m=0;else a:{for(var Rj=yn(),Sj=u(Rj.U),Rf=Sj.next();!Rf.done;Rf=Sj.next()){var Tj=Rf.value;if(S.message&&S.message.match(Tj.Vb)){m=Tj.weight;
break a}}for(var Uj=u(Rj.S),Sf=Uj.next();!Sf.done;Sf=Uj.next()){var Vj=Sf.value;if(Vj.kb(S)){m=Vj.weight;break a}}m=1}S.sampleWeight=m;for(var Wj=u(tn),Tf=Wj.next();!Tf.done;Tf=Wj.next()){var Uf=Tf.value;if(Uf.wa[S.name])for(var Xj=u(Uf.wa[S.name]),Vf=Xj.next();!Vf.done;Vf=Xj.next()){var Yj=Vf.value,Td=S.message.match(Yj.regexp);if(Td){S.params["params.error.original"]=Td[0];for(var Wf=Yj.groups,Zj={},bc=0;bc<Wf.length;bc++)Zj[Wf[bc]]=Td[bc+1],S.params["params.error."+Wf[bc]]=Td[bc+1];S.message=Uf.Ea(Zj);
break}}}S.params||(S.params={});var ak=yn();S.params["params.errorServiceSignature"]="msg="+ak.U.length+"&cb="+ak.S.length;S.params["params.serviceWorker"]="false";A.document&&A.document.querySelectorAll&&(S.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));yb("sample").constructor!==xb&&(S.params["params.fconst"]="true");var ra=S;window.yterr&&"function"===typeof window.yterr&&window.yterr(ra);if(0!==ra.sampleWeight&&!Fn.has(ra.message)){if("ERROR"===h){zn.da("handleError",
ra);if(N("record_app_crashed_web")&&0===In&&1===ra.sampleWeight)if(In++,N("errors_via_jspb")){var Xf=new rh;F(Xf,1,1);if(!N("report_client_error_with_app_crash_ks")){var bk=new mh;F(bk,1,ra.message);var ck=new nh;H(ck,mh,3,bk);var dk=new oh;H(dk,nh,5,ck);var ek=new ph;H(ek,oh,9,dk);H(Xf,ph,4,ek)}var lo=Xf,fk=new uh;kd(fk,rh,20,vh,lo);rn(fk)}else{var gk={appCrashType:"APP_CRASH_TYPE_BREAKPAD"};N("report_client_error_with_app_crash_ks")||(gk.systemHealth={crashData:{clientError:{logMessage:{message:ra.message}}}});
sn("appCrashed",gk)}Hn++}else"WARNING"===h&&zn.da("handleWarning",ra);if(N("kevlar_gel_error_routing"))a:{var Yf=void 0,Zf=void 0,Mc=h,Q=ra;if(N("errors_via_jspb")){if(Ln())Zf=void 0;else{var cc=new jh;F(cc,1,Q.stack);Q.fileName&&F(cc,4,Q.fileName);var Na=Q.lineNumber&&Q.lineNumber.split?Q.lineNumber.split(":"):[];0!==Na.length&&(1!==Na.length||isNaN(Number(Na[0]))?2!==Na.length||isNaN(Number(Na[0]))||isNaN(Number(Na[1]))||(F(cc,2,Number(Na[0])),F(cc,3,Number(Na[1]))):F(cc,2,Number(Na[0])));var sb=
new mh;F(sb,1,Q.message);F(sb,3,Q.name);F(sb,6,Q.sampleWeight);"ERROR"===Mc?F(sb,2,2):"WARNING"===Mc?F(sb,2,1):F(sb,2,0);var $f=new kh;F($f,1,!0);kd($f,jh,3,lh,cc);var tb=new gh;F(tb,3,window.location.href);for(var hk=L("FEXP_EXPERIMENTS",[]),ag=0;ag<hk.length;ag++){var ik=tb,mo=hk[ag];Sc(ik);fd(ik,5).push(mo)}var bg=Gh();if(!Hh()&&bg)for(var jk=u(Object.keys(bg)),ub=jk.next();!ub.done;ub=jk.next()){var kk=ub.value,cg=new ih;F(cg,1,kk);cg.setValue(String(bg[kk]));md(tb,4,ih,cg)}var dg=Q.params;if(dg){var lk=
u(Object.keys(dg));for(ub=lk.next();!ub.done;ub=lk.next()){var mk=ub.value,eg=new ih;F(eg,1,"client."+mk);eg.setValue(String(dg[mk]));md(tb,4,ih,eg)}}var nk=L("SERVER_NAME"),ok=L("SERVER_VERSION");if(nk&&ok){var fg=new ih;F(fg,1,"server.name");fg.setValue(nk);md(tb,4,ih,fg);var gg=new ih;F(gg,1,"server.version");gg.setValue(ok);md(tb,4,ih,gg)}var Ud=new nh;H(Ud,gh,1,tb);H(Ud,kh,2,$f);H(Ud,mh,3,sb);Zf=Ud}var pk=Zf;if(!pk)break a;var qk=new uh;kd(qk,nh,163,vh,pk);rn(qk)}else{if(Ln())Yf=void 0;else{var Nc=
{stackTrace:Q.stack};Q.fileName&&(Nc.filename=Q.fileName);var Oa=Q.lineNumber&&Q.lineNumber.split?Q.lineNumber.split(":"):[];0!==Oa.length&&(1!==Oa.length||isNaN(Number(Oa[0]))?2!==Oa.length||isNaN(Number(Oa[0]))||isNaN(Number(Oa[1]))||(Nc.lineNumber=Number(Oa[0]),Nc.columnNumber=Number(Oa[1])):Nc.lineNumber=Number(Oa[0]));var hg={level:"ERROR_LEVEL_UNKNOWN",message:Q.message,errorClassName:Q.name,sampleWeight:Q.sampleWeight};"ERROR"===Mc?hg.level="ERROR_LEVEL_ERROR":"WARNING"===Mc&&(hg.level="ERROR_LEVEL_WARNNING");
var no={isObfuscated:!0,browserStackInfo:Nc},dc={pageUrl:window.location.href,kvPairs:[]};L("FEXP_EXPERIMENTS")&&(dc.experimentIds=L("FEXP_EXPERIMENTS"));var ig=Gh();if(!Hh()&&ig)for(var rk=u(Object.keys(ig)),vb=rk.next();!vb.done;vb=rk.next()){var sk=vb.value;dc.kvPairs.push({key:sk,value:String(ig[sk])})}var jg=Q.params;if(jg){var tk=u(Object.keys(jg));for(vb=tk.next();!vb.done;vb=tk.next()){var uk=vb.value;dc.kvPairs.push({key:"client."+uk,value:String(jg[uk])})}}var vk=L("SERVER_NAME"),wk=L("SERVER_VERSION");
vk&&wk&&(dc.kvPairs.push({key:"server.name",value:vk}),dc.kvPairs.push({key:"server.version",value:wk}));Yf={errorMetadata:dc,stackTrace:no,logMessage:hg}}var xk=Yf;if(!xk)break a;sn("clientError",xk)}if("ERROR"===Mc||N("errors_flush_gel_always_killswitch"))b:if(N("migrate_events_to_ts"))c:{if(N("web_fp_via_jspb")&&(pn(!0),!N("web_fp_via_jspb_and_json")))break c;pn()}else{if(N("web_fp_via_jspb")&&(pn(!0),!N("web_fp_via_jspb_and_json")))break b;pn()}}if(!N("suppress_error_204_logging")){var wb=ra,
Oc=wb.params||{},ab={urlParams:{a:"logerror",t:"jserror",type:wb.name,msg:wb.message.substr(0,250),line:wb.lineNumber,level:h,"client.name":Oc.name},postParams:{url:L("PAGE_NAME",window.location.href),file:wb.fileName},method:"POST"};Oc.version&&(ab["client.version"]=Oc.version);if(ab.postParams){wb.stack&&(ab.postParams.stack=wb.stack);for(var yk=u(Object.keys(Oc)),kg=yk.next();!kg.done;kg=yk.next()){var zk=kg.value;ab.postParams["client."+zk]=Oc[zk]}var lg=Gh();if(lg)for(var Ak=u(Object.keys(lg)),
mg=Ak.next();!mg.done;mg=Ak.next()){var Bk=mg.value;ab.postParams[Bk]=lg[Bk]}var Ck=L("SERVER_NAME"),Dk=L("SERVER_VERSION");Ck&&Dk&&(ab.postParams["server.name"]=Ck,ab.postParams["server.version"]=Dk)}ri(L("ECATCHER_REPORT_HOST","")+"/error_204",ab)}try{Fn.add(ra.message)}catch(so){}Gn++}}}}}else throw ac;}else console&&console.warn&&console.warn("The YouTube player is not attached to the DOM. API calls should be made after the onReady event. See more: https://developers.google.com/youtube/iframe_api_reference#Events")};function go(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
function ho(a){return 0===a.search("get")||0===a.search("is")}
;function io(a,b){Zn.call(this,a,Object.assign({title:"video player",videoId:"",width:640,height:360},b||{}),"player");this.M={};this.playerInfo={};this.videoTitle=""}
v(io,Zn);n=io.prototype;n.Oa=function(){var a=Z(this.j,"playerVars");a?a=mb(a):a={};window!==window.top&&document.referrer&&(a.widget_referrer=document.referrer.substring(0,256));var b=Z(this.j,"embedConfig");if(b){if(Pa(b))try{b=JSON.stringify(b)}catch(c){console.error("Invalid embed config JSON",c)}a.embed_config=b}return a};
n.La=function(a){var b=a.event;a=a.info;switch(b){case "apiInfoDelivery":if(Pa(a))for(var c in a)a.hasOwnProperty(c)&&(this.M[c]=a[c]);break;case "infoDelivery":jo(this,a);break;case "initialDelivery":Pa(a)&&(window.clearInterval(this.l),this.playerInfo={},this.M={},ko(this,a.apiInterface),jo(this,a));break;default:$n(this,b,a)}};
function jo(a,b){if(Pa(b)){for(var c in b)b.hasOwnProperty(c)&&(a.playerInfo[c]=b[c]);a.playerInfo.hasOwnProperty("videoData")&&(b=a.playerInfo.videoData,b.hasOwnProperty("title")&&b.title?(b=b.title,b!==a.videoTitle&&(a.videoTitle=b,a.i.setAttribute("title",b))):(a.videoTitle="",a.i.setAttribute("title","YouTube "+Z(a.j,"title"))))}}
function ko(a,b){D(b,function(c){this[c]||("getCurrentTime"===c?this[c]=function(){var d=this.playerInfo.currentTime;if(1===this.playerInfo.playerState){var e=(Date.now()/1E3-this.playerInfo.currentTimeLastUpdated_)*this.playerInfo.playbackRate;0<e&&(d+=Math.min(e,1))}return d}:go(c)?this[c]=function(){this.playerInfo={};
this.M={};co(this,c,arguments);return this}:ho(c)?this[c]=function(){var d=0;
0===c.search("get")?d=3:0===c.search("is")&&(d=2);return this.playerInfo[c.charAt(d).toLowerCase()+c.substr(d+1)]}:this[c]=function(){co(this,c,arguments);
return this})},a)}
...
function oo(a){if("iframe"!==a.tagName.toLowerCase()){var b=Tn(a,"videoid");b&&(b={videoId:b,width:Tn(a,"width"),height:Tn(a,"height")},new io(a,b))}}
...
C("YT.scan",Sn);C("YT.subscribe",function(a,b,c){Bg.subscribe(a,b,c);Rn[a]=!0;for(var d in Pn)Pn.hasOwnProperty(d)&&bo(Pn[d],a)});
C("YT.unsubscribe",function(a,b,c){Ag(a,b,c)});
C("YT.Player",io);Zn.prototype.destroy=Zn.prototype.destroy;Zn.prototype.setSize=Zn.prototype.setSize;Zn.prototype.getIframe=Zn.prototype.getIframe;Zn.prototype.addEventListener=Zn.prototype.addEventListener;io.prototype.getVideoEmbedCode=io.prototype.getVideoEmbedCode;io.prototype.getOptions=io.prototype.getOptions;io.prototype.getOption=io.prototype.getOption;
...
"yt-player");h&&(f[d++]=b)}f.length=d;b=f}}b=gb(b);D(fb(a,b),oo)});
"undefined"!=typeof YTConfig&&YTConfig.parsetags&&"onload"!=YTConfig.parsetags||Sn();var po=A.onYTReady;po&&po();var qo=A.onYouTubeIframeAPIReady;qo&&qo();var ro=A.onYouTubePlayerAPIReady;ro&&ro();}).call(this);
